...
<section class="bg-white rounded-xl border border-gray-200">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-12">
        <h2 class=" text-xl text-center font-bold text-gray-900 mb-5 ">Edit Peminjaman</h2>
        <form action="{{ route('peminjaman.update',$detailPeminjaman->f_id) }}" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    <select name="f_iddetailbuku" id="f_iddetailbuku" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        @foreach ($buku as $b)
                        <option value="{{$b->f_id}}" {{$b->f_id == $detailPeminjaman->detailbuku->buku->f_id ? 'selected' : ''}}>{{$b->buku->f_judul}}</option>
                ...
                <div>
                    ...
                    <input type="date" name="f_tanggalpeminjaman" id="f_tanggalpeminjaman" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="" value="{{$detailPeminjaman->peminjaman->f_tanggalpeminjaman}}">
